...
<a class="ui-dialog-closebutton" href="hello.do"></a>
	...
	<form action="sendemail.do" >
		<div class="ui-dialog-l40 ui-dialog-pt15">
			...
			<input class="ui-dialog-input ui-dialog-input-username" type="text" value="用户名"  name="username"/>
			<input class="ui-dialog-input ui-dialog-input-username" type="text" value="注册时所用邮箱（必填）" name="email"/>

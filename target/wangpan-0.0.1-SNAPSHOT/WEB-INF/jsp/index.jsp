	...
	<div class="top">
		<div class="title">
			...
			<span> ${sessionScope.SharedWarehouseUserName}
				你好！&nbsp;&nbsp;&nbsp; <a class="bold" href="uploadrequest.do">上传文件</a>&nbsp;
				<a class="bold" href="downloadfiletype.do?type=enjoy&style=enjoyall">下载文件</a>&nbsp;
				<a class="bold" href="setrequest.do">管理员</a>&nbsp; <a class="bold"
				href="http://10.22.63.253/">内网登录</a>&nbsp; <a class="bold" href="http://www.nbu.edu.cn/">校园首页</a>&nbsp;
				<a class="list" href="https://www.duba.com/?f=liebao">更多</a>&nbsp;
			</span>
		</div>
	</div>
	<div class="body">

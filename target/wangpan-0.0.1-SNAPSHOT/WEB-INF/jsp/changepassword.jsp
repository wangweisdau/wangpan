...
<title>修改密码 - 共享仓库 - Thousands Happy</title>
<style type="text/css">
...
<a class="ui-dialog-closebutton" href="hello.do"></a>
	...
	<form action="changepassword.do" >
		<div class="ui-dialog-l40 ui-dialog-pt15">
			...
			<input class="ui-dialog-input ui-dialog-input-password" type="text" value="新密码"  name="newpassword"/>
			<input class="ui-dialog-input ui-dialog-input-password" type="text" value="重输新密码" name="newpassword1"/>

...
<a class="ui-dialog-closebutton" href="hello.do"></a>
	...
	<form action="changepassword.do" >
		<div class="ui-dialog-l40 ui-dialog-pt15">
			...
			<input class="ui-dialog-input ui-dialog-input-password" type="text"   name="newpassword" placeholder="输入新密码" required/>
			<input class="ui-dialog-input ui-dialog-input-password" type="text"  name="newpassword1" placeholder="重输新密码" required/>
		<input class="ui-dialog-submit" type="submit" value="我已牢记密码"><br/>
		</div>
		</form>

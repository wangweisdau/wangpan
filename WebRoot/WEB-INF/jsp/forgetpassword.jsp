...
<title>忘记密码- 共享仓库 - Thousands Happy</title>
<style type="text/css">
...
<a class="ui-dialog-closebutton" href="hello.do"></a>
	...
	<form action="sendemail.do" >
		<div class="ui-dialog-l40 ui-dialog-pt15">
			...
			<input class="ui-dialog-input ui-dialog-input-username" type="text" name="username" placeholder="用户名" required  />
			<input class="ui-dialog-input ui-dialog-input-username" type="text" name="email" placeholder="注册时所有邮箱" required />
